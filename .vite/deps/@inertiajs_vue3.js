...
function Ie(r4, e, t) {
  ...
  function m() {
    let l = e(""), v = { ...l ? { title: `<title inertia="">${l}</title>` } : {} }, _2 = Object.values(i).reduce((S, E) => S.concat(E), []).reduce((S, E) => {
...
var z2 = { created() {
  ...
  let e = this.$options.remember.key instanceof Function ? this.$options.remember.key.call(this) : this.$options.remember.key, r4 = Wr.restore(e), n = this.$options.remember.data.filter((o2) => !(this[o2] !== null && typeof this[o2] == "object" && this[o2].__rememberable === false)), i = (o2) => this[o2] !== null && typeof this[o2] == "object" && typeof this[o2].__remember == "function" && typeof this[o2].__restore == "function";
  n.forEach((o2) => {
    this[o2] !== void 0 && r4 !== void 0 && r4[o2] !== void 0 && (i(o2) ? this[o2].__restore(r4[o2]) : this[o2] = r4[o2]), this.$watch(o2, () => {
      Wr.remember(n.reduce((a, l) => ({ ...a, [l]: (0, import_lodash.default)(i(l) ? this[l].__remember() : this[l]) }), {}), e);
    }, { immediate: true, deep: true });
  });
} };
var N2 = z2;
function k2(e, r4) {
  let n = typeof e == "string" ? e : null, i = (typeof e == "string" ? r4 : e) ?? {}, o2 = n ? Wr.restore(n) : null, a = typeof i == "function" ? (0, import_lodash2.default)(i()) : (0, import_lodash2.default)(i), l = null, f2 = null, m = (t) => t, v = reactive({ ...o2 ? o2.data : (0, import_lodash2.default)(a), isDirty: false, errors: o2 ? o2.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    return Object.keys(a).reduce((t, s2) => (t[s2] = this[s2], t), {});
  }, transform(t) {
    return m = t, this;
  }, defaults(t, s2) {
    if (typeof i == "function") throw new Error("You cannot call `defaults()` when using a function to define your form data.");
    return typeof t > "u" ? (a = this.data(), this.isDirty = false) : a = Object.assign({}, (0, import_lodash2.default)(a), typeof t == "string" ? { [t]: s2 } : t), this;
  }, reset(...t) {
    let s2 = typeof i == "function" ? (0, import_lodash2.default)(i()) : (0, import_lodash2.default)(a), d = (0, import_lodash2.default)(s2);
    return t.length === 0 ? (a = d, Object.assign(this, s2)) : Object.keys(s2).filter((p2) => t.includes(p2)).forEach((p2) => {
      a[p2] = d[p2], this[p2] = s2[p2];
    }), this;
  }, setError(t, s2) {
    return Object.assign(this.errors, typeof t == "string" ? { [t]: s2 } : t), this.hasErrors = Object.keys(this.errors).length > 0, this;
  }, clearErrors(...t) {
    return this.errors = Object.keys(this.errors).reduce((s2, d) => ({ ...s2, ...t.length > 0 && !t.includes(d) ? { [d]: this.errors[d] } : {} }), {}), this.hasErrors = Object.keys(this.errors).length > 0, this;
  }, submit(...t) {
    let s2 = typeof t[0] == "object", d = s2 ? t[0].method : t[0], p2 = s2 ? t[0].url : t[1], u2 = (s2 ? t[1] : t[2]) ?? {}, F2 = m(this.data()), T2 = { ...u2, onCancelToken: (c) => {
      ...
      let O2 = u2.onSuccess ? await u2.onSuccess(c) : null;
    ...
    this.submit("get", t, s2);
  }, post(t, s2) {
    this.submit("post", t, s2);
  }, put(t, s2) {
    this.submit("put", t, s2);
  }, patch(t, s2) {
    this.submit("patch", t, s2);
  }, delete(t, s2) {
    this.submit("delete", t, s2);
  }, cancel() {
    l && l.cancel();
  ...
  return watch(v, (t) => {
    v.isDirty = !(0, import_lodash3.default)(v.data(), a), n && Wr.remember((0, import_lodash2.default)(t.__remember()), n);
  }, { immediate: true, deep: true }), v;
}
var y2 = ref(null);
var g2 = ref(null);
var D2 = shallowRef(null);
var x2 = ref(null);
var _ = null;
...
} } }, setup({ initialPage: e, initialComponent: r4, resolveComponent: n, titleCallback: i, onHeadUpdate: o2 }) {
  y2.value = r4 ? markRaw(r4) : null, g2.value = e, x2.value = null;
  let a = typeof window > "u";
  return _ = Ie(a, i, o2), a || (Wr.init({ initialPage: e, resolveComponent: n, swapComponent: async (l) => {
    y2.value = markRaw(l.component), g2.value = l.page, x2.value = l.preserveState ? x2.value : Date.now();
  } }), Wr.on("navigate", () => _.forceUpdate())), () => {
    if (y2.value) {
      y2.value.inheritAttrs = !!y2.value.inheritAttrs;
      let l = h(y2.value, { ...g2.value.props, key: x2.value });
      return D2.value && (y2.value.layout = D2.value, D2.value = null), y2.value.layout ? typeof y2.value.layout == "function" ? y2.value.layout(h, l) : (Array.isArray(y2.value.layout) ? y2.value.layout : [y2.value.layout]).concat(l).reverse().reduce((f2, m) => (m.inheritAttrs = !!m.inheritAttrs, h(m, { ...g2.value.props }, () => f2))) : l;
    }
  };
} });
var L2 = oe2;
var H = { install(e) {
  Wr.form = k2, Object.defineProperty(e.config.globalProperties, "$inertia", { get: () => Wr }), Object.defineProperty(e.config.globalProperties, "$page", { get: () => g2.value }), Object.defineProperty(e.config.globalProperties, "$headManager", { get: () => _ }), e.mixin(N2);
} };
function ne2() {
...
async function B2({ id: e = "app", resolve: r4, setup: n, title: i, progress: o2 = {}, page: a, render: l }) {
  let f2 = typeof window > "u", m = f2 ? null : document.getElementById(e), v = a || JSON.parse(m.dataset.page), t = (p2) => Promise.resolve(r4(p2)).then((u2) => u2.default || u2), s2 = [], d = await Promise.all([t(v.component), Wr.decryptHistory().catch(() => {
  })]).then(([p2]) => n({ el: m, App: L2, props: { initialPage: v, initialComponent: p2, resolveComponent: t, titleCallback: i, onHeadUpdate: f2 ? (u2) => s2 = u2 : null }, plugin: H }));
  if (!f2 && o2 && Ne(o2), f2) {
    let p2 = await l(createSSRApp({ render: () => h("div", { id: e, "data-page": JSON.stringify(v), innerHTML: d ? l(d) : "" }) }));
    return { head: s2, body: p2 };
  }
}
...
var fe2 = defineComponent({ props: { title: { type: String, required: false } }, data() {
  ...
  let r4 = Object.keys(e.props).reduce((n, i) => {
    let o2 = e.props[i];
    return ["key", "head-key"].includes(i) ? n : o2 === "" ? n + ` ${i}` : n + ` ${i}="${o2}"`;
  }, "");
  return `<${e.type}${r4}>`;
}, renderTagChildren(e) {
...
var be2 = defineComponent({ name: "Link", props: { as: { type: String, default: "a" }, data: { type: Object, default: () => ({}) }, href: { type: String, required: true }, method: { type: String, default: "get" }, replace: { type: Boolean, default: false }, preserveScroll: { type: Boolean, default: false }, preserveState: { type: Boolean, default: null }, only: { type: Array, default: () => [] }, except: { type: Array, default: () => [] }, headers: { type: Object, default: () => ({}) }, queryStringArrayFormat: { type: String, default: "brackets" }, async: { type: Boolean, default: false }, prefetch: { type: [Boolean, String, Array], default: false }, cacheFor: { type: [Number, String, Array], default: 0 }, onStart: { type: Function, default: (e) => {
  ...
  let i = ref(0), o2 = ref(null), a = e.prefetch === true ? ["hover"] : e.prefetch === false ? [] : Array.isArray(e.prefetch) ? e.prefetch : [e.prefetch], l = e.cacheFor !== 0 ? e.cacheFor : a.length === 1 && a[0] === "click" ? 0 : 3e4;
  onMounted(() => {
    a.includes("mount") && F2();
  }), onUnmounted(() => {
    clearTimeout(o2.value);
  });
  let f2 = typeof e.href == "object" ? e.href.method : e.method.toLowerCase(), m = f2 !== "get" ? "button" : e.as.toLowerCase(), v = computed(() => Te(f2, typeof e.href == "object" ? e.href.url : e.href || "", e.data, e.queryStringArrayFormat)), t = computed(() => v.value[0]), s2 = computed(() => v.value[1]), d = computed(() => ({ a: { href: t.value }, button: { type: "button" } })), p2 = { data: s2.value, method: f2, replace: e.replace, preserveScroll: e.preserveScroll, preserveState: e.preserveState ?? f2 !== "get", only: e.only, except: e.except, headers: e.headers, async: e.async }, u2 = { ...p2, onCancelToken: e.onCancelToken, onBefore: e.onBefore, onStart: (h2) => {
    i.value++, e.onStart(h2);
  }, onProgress: e.onProgress, onFinish: (h2) => {
    i.value--, e.onFinish(h2);
    ...
    clearTimeout(o2.value);
  }, onClick: T2.onClick }, O2 = { onMousedown: (h2) => {
  ...
  return () => h(m, { ...n, ...d.value[m] || {}, "data-loading": i.value > 0 ? "" : void 0, ...a.includes("hover") ? c : a.includes("click") ? O2 : T2 }, r4);
} });
var Pe2 = be2;
function U2(e, r4 = {}, n = { keepAlive: false, autoStart: true }) {
  let { stop: i, start: o2 } = Wr.poll(e, r4, { ...n, autoStart: false });
  return onMounted(() => {
    (n.autoStart ?? true) && o2();
  }), onUnmounted(() => {
    i();
...
function W2(e = {}) {
  let r4 = ref(false), n = ref(null), i = ref(false), o2 = typeof window > "u" ? null : Wr.getCached(window.location.pathname, e), a = typeof window > "u" ? null : Wr.getPrefetching(window.location.pathname, e);
  n.value = (o2 == null ? void 0 : o2.staleTimestamp) || null, r4.value = a !== null, i.value = o2 !== null;
  let l, f2;
  return onMounted(() => {
    f2 = Wr.on("prefetching", (m) => {
      m.detail.visit.url.pathname === window.location.pathname && (r4.value = true);
    }), l = Wr.on("prefetched", (m) => {
      m.detail.visit.url.pathname === window.location.pathname && (r4.value = false, i.value = true);
    });
  }), onUnmounted(() => {
    l(), f2();
  }), { lastUpdatedAt: n, isPrefetching: r4, isPrefetched: i, flush: () => Wr.flush(window.location.pathname, e) };
}
function Y2(e, r4) {
  if (typeof e == "object" && e !== null && e.__rememberable === false) return e;
  let n = Wr.restore(r4), i = isReactive(e) ? reactive : ref, o2 = typeof e.__remember == "function" && typeof e.__restore == "function", a = i(n === void 0 ? e : o2 ? e.__restore(n) : n);
  return watch(a, (l) => {
    Wr.remember((0, import_lodash4.default)(o2 ? e.__remember() : l), r4);
